...
const MindlyCard = ({ selectedEntry, onUpdate }) => {
  ...
  // Helper functions
  const getMoodIcon = useCallback((mood) => moodIcons[mood] || null, []);
  ...
  const truncate = useCallback((text, max) =>
  ...
  }, [entry, formatDate, truncate, getMoodIcon, handleCardClick, handleEditClick]);
